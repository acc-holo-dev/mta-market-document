...
**Решение: PLAN-008 — Follow Expansion (Creator + Resource).** Переход
состояния: из «follow есть только у серверов» в «пользователь может следить
за создателем и за конкретным ресурсом и получать уведомления о релизах,
