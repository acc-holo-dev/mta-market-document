...
**Решение: PLAN-009 — Thread Follow (Community Loop completion).** Переход
состояния: из «следить можно только за сервером/создателем/ресурсом» в
«пользователь следит за обсуждением и получает уведомление о каждом ответе,
не участвуя в нём; сводка показывает ответы в отслеживаемых темах».
