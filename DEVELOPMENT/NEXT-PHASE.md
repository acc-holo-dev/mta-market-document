...
`DEVELOPMENT/ACTIVE/PLAN-007.md`. Переход состояния: из «статей не существует»
в «статьи — полноценная публичная сущность с модерацией, обсуждениями,
связями с ресурсами/серверами и слотом NEW_ARTICLE в daily experience».
